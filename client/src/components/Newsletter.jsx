...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        <h1 className='md:text-4xl text-2xl font-semibold'>Never Miss an Article!</h1>
        <p className='md:text-ig text-gray-500/70 pb-8'>Subscribe to get access to insightful articles about life in tech.</p>
        <form className='flex items-center justify-between max-w-full md:h-13 h-12'>
